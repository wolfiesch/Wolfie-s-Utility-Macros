...
' Constants
Private Const VERSION_FOLDER As String = "C:\temp\VersionControl\Versions\"
Private Const METADATA_FOLDER As String = "C:\temp\VersionControl\Metadata\"
...
Private Function ParseMetadataFile(filePath As String) As Dictionary
    ...
    Dim versionInfo As New Dictionary
    Dim fileNum As Integer
    fileNum = FreeFile
